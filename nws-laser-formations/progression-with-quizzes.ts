// Calcul de la progression incluant les quiz avec le même coefficient que les chapitres
// Insérer ce code dans src\app\api\courses\[courseId]\chapters\[chapterId]\progress\route.ts
